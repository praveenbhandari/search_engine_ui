...
import "./styles.css";
import React, { useState, useEffect, useCallback, useRef, Link } from "react";
          ...
          <div className="card-body">
            ...
            <div className="flex flex-col items-center space-y-4 bg-#f8f8f8">
                    ...
                    <div className="w-full text-center bg-#f8f8f8" style={{ color: '#2E2E2E' }}>
                      ...
                      <p> United Nations Committee on the Rights of Persons with Disabilities(UN CRPD) <strong>|</strong> United Nations Committee on the Elimination of Discrimination against Women(UN CEDAW)</p>
                      <p></p>
